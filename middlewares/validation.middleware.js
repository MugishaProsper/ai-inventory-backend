  ...
  create: Joi.object({
    ...
    paymentTerms: Joi.object({
      ...
      preferredPaymentMethod: Joi.string()
        .valid("cash", "check", "bank_transfer", "credit_card")
...
export const inventorySchemas = {
  ...
  updateSettings: Joi.object({
    ...
    location: Joi.string().optional().max(255),
    type: Joi.string()
      .valid("main", "backup", "retail", "warehouse")
      .optional(),
    settings: Joi.object({
...
export const aiSchemas = {
  ...
  reorderSuggestions: Joi.object({
    threshold: Joi.alternatives()
      .try(Joi.string().valid("auto"), Joi.number().integer().min(0))
      .default("auto"),
  }),
...
export const querySchemas = {
  ...
  productFilters: Joi.object({
    ...
    stockStatus: Joi.string()
      .valid("in_stock", "low_stock", "out_of_stock", "overstock")
      .optional(),
